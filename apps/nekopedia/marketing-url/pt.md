...
<div class="marketing-stat-grid" aria-label="Nekopedia at a glance">
  <article class="marketing-stat">
    ...
    <span class="marketing-stat-label">raças de gatos com perfis ricos no estilo CFA/TICA que você pode buscar e explorar</span>
  </article>
  <article class="marketing-stat">
    <span class="marketing-stat-value">2</span>
    <span class="marketing-stat-label">modos de jogo, Quiz de Raças e Curiosidades Felinas, que ampliam seu conhecimento sobre gatos</span>
  </article>
  <article class="marketing-stat">
...
<section class="marketing-band" aria-labelledby="nk-why-title">
  ...
  <div class="marketing-card-grid marketing-card-grid--two">
    <article class="marketing-card marketing-card--featured">
      <h3>Identifique qualquer gato em segundos</h3>
      <p>Aponte sua câmera para qualquer gato, ou escolha uma foto da sua galeria, e obtenha uma correspondência de raça com uma pontuação de confiança em instantes.</p>
      <ul class="marketing-list">
        ...
        <li>Funciona totalmente offline, onde quer que o gato esteja</li>
      </ul>
    </article>
    <article class="marketing-card">
      <h3>Perfis que valem a leitura</h3>
      <p>Cada raça abre um perfil no estilo CFA/TICA que explica como o gato realmente é, não apenas como ele se chama.</p>
      <ul class="marketing-list">
        <li>Temperamento, expectativa de vida, peso e altura num relance</li>
        <li>País de origem e a história da raça</li>
        <li>Detalhes claros e em linguagem simples para cada raça</li>
      </ul>
    </article>
    <article class="marketing-card">
...
<section class="marketing-band marketing-band--plain" aria-labelledby="nk-modes-title">
  <div class="marketing-section-head">
    ...
    <h2 id="nk-modes-title" class="marketing-section-title">Três maneiras de aproveitar, um guia amigável do começo ao fim.</h2>
    <p class="marketing-section-intro">Cada parte do Nekopedia responde a um humor diferente: uma pergunta rápida, uma tarde de navegação ou uma noite de jogos, mantendo o mesmo estilo claro e legível.</p>
  </div>
  <div class="marketing-card-grid marketing-card-grid--three">
    <article class="marketing-card marketing-card--featured">
      <h3>Identificar</h3>
      <p>Escaneie um gato e obtenha uma correspondência de raça com uma pontuação de confiança e outras possibilidades prováveis.</p>
      <ul class="marketing-list">
        <li>Ideal para o café, o abrigo ou o seu sofá</li>
        <li>Salve qualquer resultado para revisitar depois</li>
      </ul>
    </article>
    <article class="marketing-card">
      <h3>Explorar</h3>
      <p>Busque 48 raças por nome ou navegue por um mapa-múndi interativo organizado por país de origem.</p>
      <ul class="marketing-list">
        <li>Toque em um marcador para ver as raças daquela região</li>
        <li>Ótimo para planejar, sonhar e aprender</li>
      </ul>
    </article>
    <article class="marketing-card">
      <h3>Jogar</h3>
...
<section class="marketing-band" aria-labelledby="nk-flow-title">
  <div class="marketing-section-head">
    ...
    <h2 id="nk-flow-title" class="marketing-section-title">De uma foto à história completa em cinco passos fáceis.</h2>
  </div>
  <div class="marketing-step-grid">
    <article class="marketing-step">
      <h3>Abra o Nekopedia</h3>
      <p>Pronto em segundos, sem conta, sem cadastro e sem configuração para resolver antes.</p>
    </article>
    <article class="marketing-step">
      <h3>Tire ou escolha uma foto</h3>
      <p>Use sua câmera em qualquer gato, ou escolha uma foto existente da sua galeria.</p>
    </article>
    <article class="marketing-step">
      <h3>Veja seu resultado</h3>
      <p>Obtenha o nome da raça, uma pontuação de confiança e um perfil completo com temperamento, tamanho, origem e história.</p>
    </article>
    <article class="marketing-step">
      <h3>Salve seus favoritos</h3>
      <p>Guarde as raças que você ama em uma biblioteca pessoal que fica armazenada no seu dispositivo.</p>
    </article>
    <article class="marketing-step">
      <h3>Continue explorando</h3>
      <p>Busque raças, navegue pelo mapa-múndi ou jogue o Quiz de Raças e as Curiosidades Felinas quando quiser.</p>
    </article>
  </div>
</section>
...
<section class="marketing-band marketing-band--plain" aria-labelledby="nk-audience-title">
  <div class="marketing-section-head">
    ...
    <h2 id="nk-audience-title" class="marketing-section-title">Um presente para quem adora conhecer novos gatos.</h2>
  </div>
  <div class="marketing-story-grid">
    <article class="marketing-story-card">
      <h3>Mantenha uma biblioteca dos gatos que você encontra</h3>
      <p>Salve qualquer escaneamento com sua raça e pontuação de confiança, e revisite-o quando quiser. É útil para lembrar do gato do café, comparar semelhantes e aprender um pouco mais a cada vez.</p>
    </article>
    <article class="marketing-story-card">
      <h3>Feito para pessoas curiosas sobre gatos</h3>
      <ul class="marketing-list">
        <li>Novos donos de filhotes descobrindo a mistura de raças</li>
        <li>Visitantes de abrigos e resgates conhecendo muitos gatos</li>
        <li>Frequentadores de cafés que sempre se perguntam "que raça é essa?"</li>
        <li>Crianças e famílias aprendendo raças juntas</li>
      </ul>
    </article>
  </div>
</section>
...
<section class="marketing-band" aria-labelledby="nk-offer-title">
  <div class="marketing-section-head">
    ...
    <h2 id="nk-offer-title" class="marketing-section-title">Grátis para baixar. Privado por design.</h2>
  </div>
  <div class="marketing-price-grid">
    <article class="marketing-price-card is-featured">
      ...
      <p>Identifique raças, leia perfis completos, salve favoritos, explore o mapa e jogue ambos os jogos sem conta, sem assinatura e sem paywall.</p>
...
<section class="marketing-cta-panel" aria-labelledby="nk-next-title">
  <h2 id="nk-next-title">Pronto para dar nome a cada gato que você encontrar?</h2>
  <p>Baixe o Nekopedia, comece a escanear imediatamente e mantenha o resto do mundo das raças ao seu alcance sempre que a curiosidade surgir.</p>
  <div class="marketing-link-row">
    <a class="marketing-inline-link" href="/nekopedia/support/">Visitar suporte</a>
    <a class="marketing-inline-link" href="/nekopedia/privacy/">Ler política de privacidade</a>
