...
lang: pt
permalink: /marketing-url/solcast/pt/
---
...
## O que torna o Solcast diferente
...
- **Resumo Diário** — até 6 ações personalizadas, incluindo lembretes de feriados para mais de 100 países
- **Sugestões de Roupa** — o que vestir hoje entre partes de cima, agasalhos, calçados, acessórios e equipamento para crianças e animais
...
**Pais** — lembretes de proteção solar, dicas de camadas para clima frio e alertas de hidratação para crianças, fundamentados em diretrizes de saúde pediátrica.

**Donos de animais** — horários de passeio seguros para as patas, avisos de estresse por tempestades e sugestões de resfriamento baseados em pesquisa veterinária.

**Pessoas com alergias e enxaquecas** — alertas de pólen, monitoramento da qualidade do ar e avisos de dor de cabeça baseados na altitude, calibrados ao seu nível de sensibilidade.

**Motoristas e quem se desloca** — condições de trânsito, momento de lavar o carro e dicas de segurança ao dirigir com base no clima atual.
...
iPhone e iPad · iOS 18.0 ou posterior · iPadOS 18.0 ou posterior

## Privacidade em primeiro lugar

Sem contas. Sem análises. Sem anúncios. Sua localização é usada apenas para obter o clima e nunca é armazenada em nenhum servidor. Toda a personalização permanece no seu dispositivo.

Leia nossa [Política de Privacidade](https://www.bartlettbutter.com/privacy-policies/solcast/) completa.

## Precisa de ajuda?

Visite nossa [Página de Suporte](https://www.bartlettbutter.com/support-url/solcast/) ou envie-nos um e-mail para [contact@bartlettbutter.com](mailto:contact@bartlettbutter.com).
