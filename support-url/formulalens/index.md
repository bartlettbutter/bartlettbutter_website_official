...
layout: default
title: FormulaLens
app_icon: /support-url/formulalens/icon_FormulaLens.png
...
1. Open FormulaLens and tap **Analyze**
2. Select a product category (e.g., Moisturizer, Sunscreen, Serum)
3. Take a photo of the ingredient list or choose one from your photo library
4. View your color-coded ingredient breakdown
...
None. FormulaLens has no accounts, no analytics, no tracking, and no advertising. See our full [Privacy Policy](https://www.bartlettbutter.com/privacy-policies/formulalens/) for details.
