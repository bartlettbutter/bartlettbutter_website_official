...
- **Briefing Giornaliero** — fino a 6 azioni personalizzate, inclusi promemoria delle festività per oltre 100 paesi
- **Consigli sull'Outfit** — cosa indossare oggi tra top, capispalla, calzature, accessori e attrezzatura per bambini e animali
...
**Genitori** — promemoria di protezione solare, consigli sulla stratificazione per il freddo e avvisi di idratazione per i bambini, fondati su linee guida di salute pediatrica.

**Proprietari di animali** — orari sicuri per le zampe durante le passeggiate, avvisi di stress da temporali e suggerimenti per il raffreddamento basati sulla ricerca veterinaria.

**Chi soffre di allergie ed emicranie** — allerte pollini, monitoraggio della qualità dell'aria e avvisi di mal di testa basati sull'altitudine, calibrati sul tuo livello di sensibilità.

**Pendolari e automobilisti** — condizioni del traffico, momento giusto per lavare l'auto e consigli di sicurezza alla guida in base al meteo attuale.
...
iPhone e iPad · iOS 18.0 o successivo · iPadOS 18.0 o successivo
