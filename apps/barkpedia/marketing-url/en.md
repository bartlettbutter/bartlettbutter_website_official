...
<div class="marketing-stat-grid" aria-label="Barkpedia at a glance">
  <article class="marketing-stat">
    ...
    <span class="marketing-stat-label">dog breeds with rich, AKC-style profiles you can search and explore</span>
  </article>
  <article class="marketing-stat">
    <span class="marketing-stat-value">2</span>
    <span class="marketing-stat-label">game modes, Breed Quiz and Dog Trivia, that grow your dog knowledge</span>
  </article>
  <article class="marketing-stat">
...
<section class="marketing-band" aria-labelledby="bp-why-title">
  ...
  <div class="marketing-card-grid marketing-card-grid--two">
    <article class="marketing-card marketing-card--featured">
      <h3>Identify any dog in seconds</h3>
      <p>Point your camera at any dog, or pick a photo from your library, and get a breed match with a confidence score in moments.</p>
    ...
    <article class="marketing-card">
      ...
      <p>Each breed opens an AKC-style profile that explains what the dog is actually like, not just what it is called.</p>
      <ul class="marketing-list">
...
<section class="marketing-band marketing-band--plain" aria-labelledby="bp-modes-title">
  ...
  <div class="marketing-card-grid marketing-card-grid--three">
    <article class="marketing-card marketing-card--featured">
      <h3>Identify</h3>
      <p>Scan a dog and get a breed match with a confidence score and other likely possibilities.</p>
      <ul class="marketing-list">
        <li>Best for the park, the shelter, or your couch</li>
        <li>Save any result to revisit later</li>
      </ul>
    </article>
    <article class="marketing-card">
      <h3>Explore</h3>
      <p>Search 147 breeds by name or browse an interactive world map organized by country of origin.</p>
      <ul class="marketing-list">
...
<section class="marketing-band" aria-labelledby="bp-flow-title">
  <div class="marketing-section-head">
    ...
    <h2 id="bp-flow-title" class="marketing-section-title">From a photo to the full story in five easy steps.</h2>
  </div>
  <div class="marketing-step-grid">
    ...
    <article class="marketing-step">
      ...
      <p>Use your camera on any dog, or pick an existing photo from your library.</p>
    </article>
    <article class="marketing-step">
    ...
    <article class="marketing-step">
      ...
      <p>Search breeds, browse the world map, or play Breed Quiz and Dog Trivia whenever you like.</p>
    </article>
  </div>
</section>
...
<section class="marketing-band marketing-band--plain" aria-labelledby="bp-audience-title">
  <div class="marketing-section-head">
    ...
    <h2 id="bp-audience-title" class="marketing-section-title">A gift for anyone who loves meeting new dogs.</h2>
  </div>
  <div class="marketing-story-grid">
    <article class="marketing-story-card">
      <h3>Keep a library of the dogs you meet</h3>
      <p>Save any scan with its breed and confidence score, then revisit it anytime. It is useful for remembering the dog from the park, comparing look-alikes, and learning a little more each time.</p>
    </article>
    <article class="marketing-story-card">
      <h3>Made for curious dog people</h3>
      <ul class="marketing-list">
        <li>New puppy parents figuring out their mix</li>
        <li>Shelter and rescue visitors meeting many dogs</li>
        <li>Park regulars who always wonder "what breed is that?"</li>
...
<section class="marketing-band" aria-labelledby="bp-offer-title">
  <div class="marketing-section-head">
    ...
    <h2 id="bp-offer-title" class="marketing-section-title">Free to download. Private by design.</h2>
  </div>
...
<section class="marketing-cta-panel" aria-labelledby="bp-next-title">
  <h2 id="bp-next-title">Ready to name every dog you meet?</h2>
  <p>Download Barkpedia, start scanning immediately, and keep the rest of the breed world close at hand whenever curiosity strikes.</p>
  <div class="marketing-link-row">
    <a class="marketing-inline-link" href="/barkpedia/support/">Visit support</a>
    <a class="marketing-inline-link" href="/barkpedia/privacy/">Read privacy policy</a>
