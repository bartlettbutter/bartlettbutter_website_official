...
<div class="marketing-stat-grid" aria-label="Barkpedia at a glance">
  <article class="marketing-stat">
    ...
    <span class="marketing-stat-label">races de chiens avec des profils riches de style AKC que vous pouvez rechercher et explorer</span>
  </article>
  <article class="marketing-stat">
    <span class="marketing-stat-value">2</span>
    <span class="marketing-stat-label">modes de jeu, Quiz des Races et Anecdotes Canines, qui développent vos connaissances canines</span>
  </article>
  <article class="marketing-stat">
...
<section class="marketing-band" aria-labelledby="bp-why-title">
  ...
  <div class="marketing-card-grid marketing-card-grid--two">
    <article class="marketing-card marketing-card--featured">
      <h3>Identifiez n'importe quel chien en quelques secondes</h3>
      <p>Pointez votre appareil photo vers n'importe quel chien, ou choisissez une photo dans votre galerie, et obtenez une correspondance de race avec un score de confiance en un instant.</p>
    ...
    <article class="marketing-card">
      ...
      <p>Chaque race ouvre un profil de style AKC qui explique à quoi ressemble vraiment le chien, pas seulement son nom.</p>
      <ul class="marketing-list">
...
<section class="marketing-band marketing-band--plain" aria-labelledby="bp-modes-title">
  ...
  <div class="marketing-card-grid marketing-card-grid--three">
    <article class="marketing-card marketing-card--featured">
      <h3>Identifier</h3>
      <p>Scannez un chien et obtenez une correspondance de race avec un score de confiance et d'autres possibilités probables.</p>
      <ul class="marketing-list">
        <li>Idéal pour le parc, le refuge ou votre canapé</li>
        <li>Enregistrez n'importe quel résultat pour le consulter plus tard</li>
      </ul>
    </article>
    <article class="marketing-card">
      <h3>Explorer</h3>
      <p>Recherchez 147 races par nom ou parcourez une carte du monde interactive organisée par pays d'origine.</p>
      <ul class="marketing-list">
...
<section class="marketing-band" aria-labelledby="bp-flow-title">
  <div class="marketing-section-head">
    ...
    <h2 id="bp-flow-title" class="marketing-section-title">D'une photo à toute l'histoire en cinq étapes faciles.</h2>
  </div>
  <div class="marketing-step-grid">
    <article class="marketing-step">
      <h3>Ouvrez Barkpedia</h3>
    ...
    <article class="marketing-step">
      ...
      <p>Utilisez votre appareil photo sur n'importe quel chien, ou choisissez une photo existante dans votre galerie.</p>
    </article>
    <article class="marketing-step">
    ...
    <article class="marketing-step">
      ...
      <p>Recherchez des races, parcourez la carte du monde ou jouez au Quiz des Races et aux Anecdotes Canines quand vous voulez.</p>
    </article>
  </div>
</section>
...
<section class="marketing-band marketing-band--plain" aria-labelledby="bp-audience-title">
  <div class="marketing-section-head">
    ...
    <h2 id="bp-audience-title" class="marketing-section-title">Un cadeau pour tous ceux qui aiment rencontrer de nouveaux chiens.</h2>
  </div>
  <div class="marketing-story-grid">
    <article class="marketing-story-card">
      <h3>Gardez une bibliothèque des chiens que vous rencontrez</h3>
      <p>Enregistrez n'importe quel scan avec sa race et son score de confiance, puis consultez-le à tout moment. C'est utile pour se souvenir du chien du parc, comparer les sosies et apprendre un peu plus à chaque fois.</p>
    </article>
    <article class="marketing-story-card">
      <h3>Conçu pour les curieux des chiens</h3>
      <ul class="marketing-list">
        <li>Nouveaux propriétaires de chiots cherchant à comprendre leur croisement</li>
        <li>Visiteurs de refuges et de sauvetages rencontrant de nombreux chiens</li>
        <li>Habitués du parc qui se demandent toujours « quelle race est-ce ? »</li>
...
<section class="marketing-band" aria-labelledby="bp-offer-title">
  <div class="marketing-section-head">
    ...
    <h2 id="bp-offer-title" class="marketing-section-title">Téléchargement gratuit. Privé par conception.</h2>
  </div>
...
<section class="marketing-cta-panel" aria-labelledby="bp-next-title">
  <h2 id="bp-next-title">Prêt à nommer chaque chien que vous rencontrez ?</h2>
  <p>Téléchargez Barkpedia, commencez à scanner immédiatement et gardez le reste du monde des races à portée de main dès que la curiosité surgit.</p>
  <div class="marketing-link-row">
    <a class="marketing-inline-link" href="/barkpedia/support/">Voir l'assistance</a>
    <a class="marketing-inline-link" href="/barkpedia/privacy/">Lire la politique de confidentialité</a>
