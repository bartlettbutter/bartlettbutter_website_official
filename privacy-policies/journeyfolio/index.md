...
We do not sell, rent, or share your data with any third parties. The only external communication the app makes is the service requests described above.

## Permissions

Journeyfolio does not request any special device permissions. No camera, location, contacts, microphone, or tracking access is needed.
